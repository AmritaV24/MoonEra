<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegisterSuccess.aspx.cs" Inherits="MoonEra.RegisterSuccess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="success-container">
        <div class="congratulations-text">
            ...
            You are all registered and ready to go.<br />
            Click below to log in and explore:
        </div>
        <asp:Button ID="btnLogin" runat="server" Text="Log In" CssClass="btn-login" PostBackUrl="~/Login.aspx" />
    </div>
</asp:Content>
